 ...
 *           Completely unused in actual program, but a useful reference for coding.
 * @version 0.1
 * @date 2025-03-08
 * 
...
int main(){
    ...
    // ===========================================================
        ...
        unsigned int default_main_flags = 0;
        int main_window = InitWindowPro(400, 400, (window_title).c_str(), default_main_flags);
