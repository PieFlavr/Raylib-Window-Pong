...
int main(){
    ...
    music.Load("../../custom_assets/as1/musicEC.mp3");  //Sound Effect (10 pts)
    dialogue.Load("../../custom_assets/as1/dialogueEC.mp3"); //Dialogue (10 pts)
    ping.Load("../../custom_assets/as1/pingEC.mp3");  //Music (10pts)
    /*
